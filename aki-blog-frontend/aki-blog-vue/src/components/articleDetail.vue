...
<template>
        <div class="detailBox tcommonBox" >
            ...
            <header>
                ...
                <h2>
                    <i class="fa fa-fw fa-user"></i>文章發表於 <span >{{detailObj.createTime}}</span> •
                    <i class="fa fa-fw fa-eye"></i>{{detailObj.viewCount}} 次瀏覽 •
                </h2>
                <div class="ui label">
            ...
            <div class="donate">
                <div class="donate-word">
                    <span @click="pdonate=!pdonate">贊助</span>
                </div>
            </div>
        </div>
</template>
...
import { mavonEditor } from 'mavon-editor'
    ...
    export default {
        data() { 
            return {
                aid:'', // Article ID
                pdonate:true, // Opening the donate control
                detailObj:{}, // returned detail data
                haslogin:false, // isLogin
                userId:''
            }
        },
        methods: { 
            ...
            routeChange:function(){
                var that = this 
                that.aid = that.$route.query.aid == undefined ? 1 : parseInt(that.$route.query.aid) // Getting sent parameter's article id
                // Judge user isExist
...
.dlikeColBox{
    display: flex;
    justify-content: flex-end; // Make content right
}
