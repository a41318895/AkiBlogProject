...
<template>
  <div class="rightlistBox">
    <section>
      ...
      <div class="r1-body">
        <p style="font-size: large ; margin-top: 8px;">Aki Chou</p>
        <p>Spend your life in your own way !</p>
        <div class="catch-me">
          <div style="margin-top: 30px;">
            ...
            <el-tooltip class="item" effect="dark" content="IG" placement="top">
              <a :href="catchMeObj.ins" target="_blank">
...
export default {
  data() {
    return {
      ...
      loveme: false,
      gotoTop: false, 
      going: false, // Is executing slide up move
      browseList: "", // Hot articles (view count base)
      artCommentList: "", // The newest comment
      catchMeObj: {
        github: "https://github.com/a41318895",
        ins: "https://www.instagram.com/aki_java_dev/"
      }
    };
  },
  methods: {
    toTopfun: function(e) {
      ...
      var timer = setInterval(function() {
        // Get the height to top of slide bar
        var osTop =
          document.documentElement.scrollTop || document.body.scrollTop;
        var ispeed = Math.floor(-osTop / 7);
        document.documentElement.scrollTop = document.body.scrollTop =
          osTop + ispeed;
        // Arrived the top, clearing timer
        if (osTop == 0) {
          that.going = false;
          clearInterval(timer);
          timer = null;
  ...
  created() {
    ...
    // Get 10 articles that has the most view count
