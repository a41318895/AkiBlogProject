...
// @tcolors:#97dffd; // Button and Tag
// @tcolorm:#64609E; // Selected Catagory color
// @tcolord:#48456D; // hover button color
...
@media screen and (max-width: 500px) { // 500px mobile
    .dlikeColBox{ // Like and keep mobile change line 
        display: block!important;
        float:none!important;
        margin: 10px auto!important;
        text-align: center!important;
    }
    .el-message-box{ // Tip pop-up window mobile display
        max-width: 80%;
    }
    .userInfoBox  .el-input, .userInfoBox  .el-textarea{ // user information center border
        max-width:280px!important;
    }
    .userInfoBox li{ // li 更改padding  缩小距離
        padding:15px 10px!important;
    }
    .userInfoBox li .el-radio-group .el-radio{ // 標籤樣式調整
        margin-left: 15px!important;
        margin-bottom: 5px;
    }
    .tFriendsBox .tf-item a{ // 好友列表自適應缩小尺寸
